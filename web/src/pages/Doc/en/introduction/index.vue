<template>
  <div>
    <h1>Introduction</h1>
<p><code>simple-mind-map</code> 【Chinese name: 白羽 mind map】 is a simple and powerful web mind map library, not dependent on any specific framework. Can help you quickly develop mind mapping products.</p>
<blockquote>
